...
export const SERVICES: ServiceDefinition[] = [
  ...
  svc({ id: 'backdropL', name: 'Large 3-Panel Backdrop', categoryId: 'backdrop', price: 2200, shortDescription: '3 layered panels · statement setup', detail: 'Three individually configured panels in layered heights for depth — each can differ in width, height, shape, print and colour.', gradient: G('#D9B8E8', '#7A8AC8') }),
  ...
  svc({ id: 'pancake', name: 'Pancake Station', categoryId: 'food', price: 1500, shortDescription: '4 hrs · up to 40 guests', detail: 'Mini pancakes cooked to order with sweet toppings.', isFoodStation: true, extraServingFils: aed(205), requiresAssets: ['pancake-cart'], gradient: G('#F7C948', '#FBD9C0') }),
  svc({ id: 'nachos', name: 'Nachos Station', categoryId: 'food', price: 1600, shortDescription: '4 hrs · up to 40 guests', detail: 'Warm nachos with cheese and dips.', isFoodStation: true, extraServingFils: aed(400), requiresAssets: ['nachos-cart'], gradient: G('#F7C948', '#E8A05B') }),
  svc({ id: 'burger', name: 'Burger Slider Station', categoryId: 'food', price: 1500, shortDescription: '4 hrs · up to 40 guests', detail: 'Mini burger sliders made fresh at the station.', isFoodStation: true, extraServingFils: aed(345), requiresAssets: ['burger-cart'], gradient: G('#FBD9C0', '#C97B63') }),
  svc({ id: 'chocfountain', name: 'Chocolate Fountain', categoryId: 'food', price: 2200, shortDescription: 'With fruits & marshmallows · 4 hrs', detail: 'Flowing chocolate with fruit and marshmallow dippers.', isFoodStation: true, extraServingFils: aed(550), requiresAssets: ['choc-fountain'], gradient: G('#C97B63', '#8a5a3b') }),
  svc({ id: 'hotchoc', name: 'Hot Chocolate Station', categoryId: 'food', price: 1500, shortDescription: '10L · serves 40–50 guests', detail: 'Ten litres of hot chocolate with marshmallows, candy canes and sauce.', isFoodStation: true, requiresAssets: ['hotchoc-urn'], gradient: G('#C97B63', '#FBD9C0') }),
  ...
  svc({ id: 'amwaj', name: 'Amwaj Slide 4x4m', categoryId: 'inflatables', price: 1250, shortDescription: '6 hrs · max 10 kids', detail: 'A 4×4 m inflatable slide, max 10 kids per ride.', isInflatable: true, requiresAssets: ['amwaj-slide'], gradient: G('#AEE7DF', '#5BCFC5') }),
  svc({ id: 'bluewater', name: 'Blue Water Slide', categoryId: 'inflatables', price: 1250, shortDescription: 'Splashy summer fun · max 10 kids', detail: 'An outdoor water slide, max 10 kids per ride. Needs water access within 15 m.', isInflatable: true, needsAdminReview: true, requiresAssets: ['blue-water-slide'], gradient: G('#7A8AC8', '#BDEBE4') }),
  svc({ id: 'bubblehouse', name: 'Bubbles House 4x4m', categoryId: 'inflatables', price: 1500, shortDescription: 'Only 1 unit · max 10 kids', detail: 'Eventana has a single Bubbles House — booking it makes it unavailable in every other package and add-on for your time window.', isInflatable: true, badge: 'Only 1 unit', requiresAssets: ['bubble-house'], gradient: G('#D9E8FB', '#BDEBE4') }),
...
export const PACKAGES: PackageDefinition[] = [
  {
    ...
    items: [
      ...
      item('10 Giveaways', 'Ten themed surprise gifts for your guests.'),
