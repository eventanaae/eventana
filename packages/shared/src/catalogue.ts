...
export const SERVICES: ServiceDefinition[] = [
  ...
  svc({ id: 'glamdolls', name: 'Glam Dolls', categoryId: 'entertainment', price: 1200, pricing: { kind: 'per_piece', minQuantity: 1 }, shortDescription: '2 hrs · they dance & hype the crowd', detail: 'Glam Dolls bring the party to life — two hours of dancing and hyping up your guests, with short breaks between songs. Not a stage act: they set the vibe and get everyone moving. Pick each doll’s look — skin tone (fair or tan) and dress colour to match your theme. Book 1 or 2 dolls; one performer each.', badge: 'Offer · was AED 1500', gradient: G('#F06CA8', '#D9B8E8') }),
