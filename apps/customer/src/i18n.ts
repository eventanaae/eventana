...
const en: Dict = {
  ...
  'cancel.tier1': '• More than 7 days before — 80% refunded (20% cancellation fee).',
  'cancel.tier2': '• 3 to 7 days before — 50% refunded.',
  'cancel.tier3': '• Less than 72 hours before — no refund.',
...
const ar: Dict = {
  ...
  'cancel.tier1': '• قبل أكثر من ٧ أيام — يُسترد ٨٠٪ (رسوم إلغاء ٢٠٪).',
  'cancel.tier2': '• قبل ٣ إلى ٧ أيام — يُسترد ٥٠٪.',
  'cancel.tier3': '• قبل أقل من ٧٢ ساعة — لا يوجد استرجاع.',
