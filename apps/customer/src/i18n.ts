...
const en: Dict = {
  ...
  'me.tipSub': '100% goes to the team — split equally. Or pick one person to thank. Paid securely by card / Apple Pay via Ziina',
...
const ar: Dict = {
  ...
  'me.tipSub': '100% للفريق — تتوزّع بالتساوي. أو اختاري شخص واحد تشكرينه. دفع آمن بالبطاقة / Apple Pay عبر Ziina',
