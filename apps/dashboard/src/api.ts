...
export const api = {
  ...
  finUpdateReceipt: (id: number, body: Record<string, unknown> & { addressNote?: string | null }) => request<any>(`/api/admin/finance/receipts/${id}`, { method: 'PATCH', body: JSON.stringify(body) }),
  ...
  finCreateReceipt: (body: Record<string, unknown> & { addressNote?: string | null }) => request<any>('/api/admin/finance/receipts', { method: 'POST', body: JSON.stringify(body) }),
